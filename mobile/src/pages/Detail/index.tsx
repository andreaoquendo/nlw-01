import React, { useState, useEffect } from 'react'; // useEffect é usado para quando dispara uma ação
...
const Detail = () => {
    ...
    const routeParams = route.params as Params; // ts, assuma que vc tem esses parâmetros
